...
class _SearchCompanyScreenState extends State<SearchCompanyScreen> {
  ...
  void initState() {
    ...
    _searchBloc!..add(CategoryCompanyEvent());
    ...
    return Scaffold(
            ...
            title: Container(
              ...
              child: TextField(
                  ...
                  onChanged: (value) {
                    ...
                    _searchBloc
                      ..add(
                          SearchMarketEvent(searchKey: _searchController.text));
                  },
        ...
        body: RefreshIndicator(
          ...
          child:
            ...
            if (state is CategoryCompaniesSuccessState) {
              category = state.companies;
            }
