...
class HandmadeDetailsScreen extends StatefulWidget {
  static const routeName = "/HandmadeDetailsScreen";
  final RouteArgument routeArgument;

  HandmadeDetailsScreen({required this.routeArgument});

  @override
  _HandmadeDetailsScreenState createState() => _HandmadeDetailsScreenState();
}

class _HandmadeDetailsScreenState extends State<HandmadeDetailsScreen> {
