                              ...
                              children: [
                                    ...
                                    children: [
                                      Text("Phone : ",
                                          style: TextStyle(
                                              ...
                                              fontSize: 13,
                                              fontWeight: FontWeight.bold)),
                                      Text(_model.company!.firstPhone.toString(),
                                          style: TextStyle(
                                ...
                                Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          _model
                                              .company!.leftDataOfCompanies!.address
                                              .toString(),
                                          style: TextStyle(
                                              color: Colors.black, fontSize: 14))
                                    ]),
                  ...
                  onPressed: ()async{
                    if (_user == null) {
                      ...
                      if (_model.company!.deviceToken != null){
                        ...
                        await canLaunch("https://wa.me/+2${
                       _model.company!.leftDataOfCompanies!.firstMobile!=null&&
